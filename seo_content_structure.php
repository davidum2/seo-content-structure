...
function scs_init_plugin()
{
    ...
    load_plugin_textdomain('seo_content_structure', false, dirname(SCS_PLUGIN_BASENAME) . '/languages');
...
function scs_activate_plugin()
{
    ...
    require_once SCS_PLUGIN_DIR . 'includes/core/class_activator.php';
...
function scs_deactivate_plugin()
{
    ...
    require_once SCS_PLUGIN_DIR . 'includes/core/class_deactivator.php';
